...
func (s *Server) Router() *gin.Engine {
	...
	router.GET("/blog", s.publicBlogIndex)
	router.GET("/blog/:slug", s.publicBlogPost)
	...
	router.GET("/admin/blogs", s.appPage)
	router.GET("/admin/blogs/:id/edit", s.appPage)
	router.GET("/admin/backup", s.appPage)
	router.GET("/admin/deleted-projects", s.appPage)
	...
	api.OPTIONS("/widget/annotations/:annotation_id/status", s.widgetOptions)
	api.OPTIONS("/widget/annotations/:annotation_id/comments", s.widgetOptions)
	api.GET("/widget/session", s.widgetSession)
	api.GET("/widget/annotations/:annotation_id", s.getWidgetAnnotation)
	...
	api.PATCH("/widget/annotations/:annotation_id/status", s.updateWidgetAnnotationStatus)
	api.POST("/widget/annotations/:annotation_id/comments", s.createWidgetAnnotationComment)
	...
	authed.POST("/teams/:id/groups", s.saveTeamGroup)
	authed.PUT("/teams/:id/groups/:groupId", s.saveTeamGroup)
	authed.DELETE("/teams/:id/groups/:groupId", s.deleteTeamGroup)
	authed.PUT("/teams/:id/members/:userId/group", s.moveTeamGroupMember)
	authed.PUT("/teams/:id/members/:userId/access", s.setTeamMemberAccess)
	...
	authed.GET("/client-tasks/:id/members", s.clientTaskMembers)
	...
	authed.GET("/tasks/:id/members", s.getTaskMembers)
	...
	owner.GET("/conflicts/overview", s.adminConflictsOverview)
	owner.GET("/conflicts/audit", s.adminConflictsAudit)
	owner.POST("/conflicts/resolve", s.adminConflictsResolve)
	...
	owner.GET("/blog/posts", s.adminBlogPosts)
	owner.POST("/blog/posts", s.adminCreateBlogPost)
	owner.GET("/blog/posts/:id", s.adminGetBlogPost)
	owner.PUT("/blog/posts/:id", s.adminUpdateBlogPost)
	owner.DELETE("/blog/posts/:id", s.adminDeleteBlogPost)
	owner.GET("/blog/categories", s.adminBlogCategories)
	owner.POST("/blog/categories", s.adminCreateBlogCategory)
	owner.PUT("/blog/categories/:id", s.adminUpdateBlogCategory)
	owner.DELETE("/blog/categories/:id", s.adminDeleteBlogCategory)
	owner.GET("/blog/tags", s.adminBlogTags)
	owner.POST("/blog/tags", s.adminCreateBlogTag)
	owner.PUT("/blog/tags/:id", s.adminUpdateBlogTag)
	owner.DELETE("/blog/tags/:id", s.adminDeleteBlogTag)
	...
	owner.GET("/deleted-projects", s.adminListDeletedProjects)
	owner.POST("/deleted-projects/:id/restore", s.adminRestoreDeletedProject)
	owner.DELETE("/deleted-projects/:id/permanent", s.adminPermanentDeleteProject)
