    ...
    async function draw() {
      try {
        ...
        if (isHourly) {
          ...
          updateClock(); clock = setInterval(updateClock, 1000);
  ...
  async function openFreelancerHelp({ tasks = [], websiteName = "Website", websiteID = "", domainScope = false } = {}) {
    ...
    function offer(person) {
      ...
      function updateBilling() {
        ...
        const hourly = (existing?.billing_type || fields.billing_type.value) === "hourly";
